...
function mapDependentPayload(dependent: DependentPayload, employeeId: string) {
  return {
    ...
    full_payload: {
      naturality: dependent.naturality || "",
      registryOffice: dependent.registryOffice || "",
      registryNumber: dependent.registryNumber || "",
      bookNumber: dependent.bookNumber || "",
      sheetNumber: dependent.sheetNumber || "",
      situationStartDate: dependent.situationStartDate || "",
      situationMotive: dependent.situationMotive || "",
      irrf: dependent.irrf || false,
      familySalary: dependent.familySalary || false,
      alimony: dependent.alimony || false,
      healthPlan: dependent.healthPlan || false,
