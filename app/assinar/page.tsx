...
export default function PalSysAssinaturaPage() {
  ...
  function getVideoId(ref: string) {
    ...
    if (ref === "dctfweb-integra-001") return "IkpKPZHazCk"
    ...
    <div className="min-h-screen bg-white text-slate-800">
      <header className="sticky top-0 z-40 border-b bg-white/95 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/privacidade-dos-sistemas" className="hover:text-yellow-600 transition">
              Privacidade
            </Link>
          </nav>
        </div>
      ...
      <div className="max-w-6xl mx-auto py-10 px-6">
        ...
        <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm leading-6 text-amber-900">
          Os valores informados são por licença mensal. Cada licença é
          destinada ao uso de 1 usuário.
        </div>
        ...
        <div className="mt-12 rounded-2xl border bg-slate-50 p-6">
          ...
          <div className="mt-4 space-y-2 text-slate-700">
            ...
            <p>
              ...
              <Link href="/privacidade-dos-sistemas" className="hover:text-yellow-600">
                Como os arquivos e dados são tratados
              </Link>
            </p>
          </div>
        </div>
